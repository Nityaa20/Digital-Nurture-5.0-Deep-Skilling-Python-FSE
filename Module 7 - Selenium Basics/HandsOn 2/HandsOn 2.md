...
- **Daily Standup:** QA reports **blocking issues** eg., "I can't test the new course endpoint because the staging environment is down" or "Found a critical defect in course creation that's blocking further testing of the enrollment flow" so the team can react immediately rather than at sprint end.
